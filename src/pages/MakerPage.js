...
//Actions
import { createMaker, signOut, signIn } from "../store/actions/authActions";
import { createFund, deleteFund } from "../store/actions/fundActions";
//Utils
import EventBus from "js-event-bus";
//Components
import MakerDashboard from "../component/MakerDashboard";
    ...
    if (
      ...
      return (
        <MakerDashboard
          ...
          createFund={this.props.createFund}
          deleteFund={this.props.deleteFund}
          donations={this.props.dontaions}
...
const mapDispatchToProps = (dispatch) => {
  return {
    createFund: (credentials) => dispatch(createFund(credentials)),
    deleteFund: (id) => dispatch(deleteFund(id)),
    createMaker: (credentials) => dispatch(createMaker(credentials)),
